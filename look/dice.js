...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-921599a8');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-921599a8');}
...
function clearFlash(){dieView.classList.remove('rl-win-921599a8');dieView.classList.remove('rl-lose-921599a8');if(frameEl){frameEl.classList.remove('rl-win-921599a8');frameEl.classList.remove('rl-lose-921599a8');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-921599a8');if(frameEl){frameEl.classList.add('rl-win-921599a8');}}else{dieView.classList.add('rl-lose-921599a8');if(frameEl){frameEl.classList.add('rl-lose-921599a8');}}
...
var brandEl=document.querySelector('.rl-brand-921599a8');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
